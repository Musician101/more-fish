...
@NullMarked
public class ThunderingCondition extends FishCondition<Boolean> {

    public ThunderingCondition(boolean value) {
        super(value);
    }

    public boolean check(Item caught, Player fisher) {
        return caught.getWorld().isThundering() == this.value;
    }
