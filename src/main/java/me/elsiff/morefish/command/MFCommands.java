...
import me.elsiff.morefish.command.argument.FishLengthArgument;
import me.elsiff.morefish.command.argument.FishTypeArgument;
...
public interface MFCommands {
    ...
    static void registerCommands() {
        registerCommand(getPlugin(), literal("morefish").executes(MFCommands::help).then(begin("begin")).then(begin("start")).then(clear()).then(contraband()).then(end()).then(give()).then(help()).then(reload()).then(shop()).then(suspend()).then(top("top")).then(top("ranking")));
    }
