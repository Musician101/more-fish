...
public final class FishingCompetitionTimerBarHandler {
    ...
    public void enableTimer(long duration) {
        String barColor = SpigotMoreFish.getInstance().getPluginConfig().getMessagesConfig().getContestBarColor();
        timerBar = Bukkit.createBossBar(timerBarKey, "", BarColor.valueOf(barColor.toUpperCase()), BarStyle.SEGMENTED_10);
